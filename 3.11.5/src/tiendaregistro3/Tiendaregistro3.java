 ...
 */
package tiendaregistro3;
import java.util.Scanner;
/**
 *
 * @author Jennifer
 */
public class Tiendaregistro3 {
    ...
    public static void main(String[] args) {
        ...
        int clientes = 0;
        int compra, opcion, pago, pago2;
        double iva, cambio, cambio2;
        int total=0;
        do {
            clientes++;
            ...
            System.out.println(cambio);
                ...
                System.out.println("dinero insuficiente, intente de nuevo.");
                 System.out.println("la cantidad de dinero con la que paga es: ");
            pago2 = scan.nextInt();
             cambio2 = pago2 -iva;
                System.out.println("su cambio es:");
